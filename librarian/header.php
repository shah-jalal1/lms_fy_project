<?php
    ...
    $page = end($page);  // Last value check
    ...
    $query = "SELECT * FROM `librarian` WHERE `email` = '$librarian_login'";
        ...
        <div class="rightside-header">
            ...
            <div class="header-section" id="user-headerbox">
                <div class="user-header-wrap">
                    ...
                    <div class="user-info">
                        <span class="user-name"><?= ucwords($librarian_info['fname'] ) . ' ' . ucwords($librarian_info['lname']) ?></span>
                ...
                <div class="nano-content">
                    <nav>
                        <ul class="nav nav-left-lines" id="main-nav">
                            <!--HOME-->
                            <li class="<?= $page == 'index.php' ? 'active-item':'' ?>"><a href="index.php"><i class="fa fa-user" aria-hidden="true"></i><span>Dashboard</span></a></li>
                            <li class="<?= $page == 'students.php' ? 'active-item':'' ?>"><a href="students.php"><i class="fa fa-user" aria-hidden="true"></i><span>Students</span></a></li>

                            <li class="has-child-item close-item <?= $page == 'add_book.php' ? 'open-item':'' ?> <?= $page == 'manage-book.php' ? 'open-item':'' ?>">
                            ...
                            <li class="<?= $page == 'issue-book.php' ? 'active-item':'' ?>"><a href="return_book.php"><i class="fa fa-book" aria-hidden="true"></i><span>Return Book</span></a></li>
